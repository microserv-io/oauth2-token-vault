...
func (_m *MockOAuthAppRepository) Create(ctx context.Context, app *modelsoauthapp.OAuthApp) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *modelsoauthapp.OAuthApp) error); ok {
		r0 = rf(ctx, app)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *MockOAuthAppRepository_Create_Call) Run(run func(ctx context.Context, app *modelsoauthapp.OAuthApp)) *MockOAuthAppRepository_Create_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*modelsoauthapp.OAuthApp))
	})
	return _c
}
...
func (_c *MockOAuthAppRepository_Create_Call) RunAndReturn(run func(context.Context, *modelsoauthapp.OAuthApp) error) *MockOAuthAppRepository_Create_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockOAuthAppRepository) Find(ctx context.Context, ownerID string, id string) (*modelsoauthapp.OAuthApp, error) {
...
func (_m *MockOAuthAppRepository) ListForProvider(ctx context.Context, providerID string) ([]*modelsoauthapp.OAuthApp, error) {
...
func (_c *MockOAuthAppRepository_ListForProvider_Call) Return(_a0 []*modelsoauthapp.OAuthApp, _a1 error) *MockOAuthAppRepository_ListForProvider_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockOAuthAppRepository_ListForProvider_Call) RunAndReturn(run func(context.Context, string) ([]*modelsoauthapp.OAuthApp, error)) *MockOAuthAppRepository_ListForProvider_Call {
	_c.Call.Return(run)
	return _c
}

// UpdateByID provides a mock function with given fields: ctx, id, updateFn
func (_m *MockOAuthAppRepository) UpdateByID(ctx context.Context, id uint, updateFn func(*modelsoauthapp.OAuthApp) error) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, uint, func(*modelsoauthapp.OAuthApp) error) error); ok {
...
//   - ctx context.Context
//   - id uint
//   - updateFn func(*modelsoauthapp.OAuthApp) error
...
func (_c *MockOAuthAppRepository_UpdateByID_Call) Run(run func(ctx context.Context, id uint, updateFn func(*modelsoauthapp.OAuthApp) error)) *MockOAuthAppRepository_UpdateByID_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(uint), args[2].(func(*modelsoauthapp.OAuthApp) error))
	})
	return _c
}
...
func (_c *MockOAuthAppRepository_UpdateByID_Call) RunAndReturn(run func(context.Context, uint, func(*modelsoauthapp.OAuthApp) error) error) *MockOAuthAppRepository_UpdateByID_Call {
	_c.Call.Return(run)
	return _c
}
