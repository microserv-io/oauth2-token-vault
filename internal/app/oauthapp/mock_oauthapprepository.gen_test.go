...
func (_m *MockOAuthAppRepository) UpdateByID(ctx context.Context, id string, updateFn func(*modelsoauthapp.OAuthApp) error) error {
...
func (_c *MockOAuthAppRepository_UpdateByID_Call) Run(run func(ctx context.Context, id string, updateFn func(*modelsoauthapp.OAuthApp) error)) *MockOAuthAppRepository_UpdateByID_Call {
	_c.Call.Run(func(args mock.Arguments) {
